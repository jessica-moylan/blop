...
There is a built in stopping condition `ImprovementGlobalStoppingStrategy` which can be used through `from ax.global_stopping.strategies.improvement import ImprovementGlobalStoppingStrategy`. 
For more information, see the `Ax documentation <https://github.com/facebook/Ax/blob/959c496ef1b9140505a57e07e5859910e0fbd36c/ax/global_stopping/strategies/improvement.py>`_
